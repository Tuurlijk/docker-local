...
cp --recursive --force /configuration/before_script/TYPO3-v9/typo3conf/* /build/Web/typo3conf/

e_arrow Setting up composer file
cp --force /configuration/before_script/TYPO3-v9/composer.json /build/
